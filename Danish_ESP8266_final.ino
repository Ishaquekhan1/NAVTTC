...
const char* ssid = "Health Monetering System";  // Enter SSID here
const char* password = "Danish786";  //Enter Password here
...
String SendHTML(float temperature, float humidity, float BPM, float SpO2, float bodytemperature) {
  ...
  ptr += "</head>";
  ptr += "<body>";
  ptr += "<h1>Patient Health Monitoring System</h1>";
  ptr += "<h3>Created by Danish Rehman</a></h3>";
